<template>
  <v-btn v-if="statusForButton === 'Accept'" @click.stop="showPopup=true" color="secondary" style="min-width: 120px;" class="mr-2">{{statusForButton}}</v-btn>
  ...
  <v-dialog v-model="showPopup" max-width="500px">
    <v-card>
      ...
      <v-card-actions style="display: flex; justify-content: center;" class="mb-3">
        <v-btn color="secondary" @click="confirm" variant="elevated" style="min-width: 120px;">Confirm</v-btn>
